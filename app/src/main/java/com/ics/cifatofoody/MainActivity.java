...
import Fragment.Offer_fragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public void updateHeader() {
        if (sessionManagement.isLoggedIn()) {
            ...
            Glide.with(this)
                    .load(BaseURL.IMG_PROFILE + getimage)
...
//            nav_menu.findItem(R.id.nav_user).setVisible(false);
    ...
    public void shareApp() {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Hi friends i am using ." + "https://play.google.com/store/apps/details?id=com.ics.cifatofoody" + " APP");
//        sendIntent.putExtra(Intent.EXTRA_TEXT, "Hi friends i am using ." + " http://cifato.com/apk" + " APP");
